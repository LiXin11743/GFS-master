...
namespace ZGZY.DALFactory
{
    ...
    public class Factory
    {
        ...
        public static ZGZY.IDAL.ICustomers GetCustomersDAL()
        {
            ZGZY.IDAL.ICustomers Customers = GetInstance("Customers") as ZGZY.IDAL.ICustomers;
            return Customers;
        }
        public static ZGZY.IDAL.IChannel GetChannelDAL()
        {
            ZGZY.IDAL.IChannel Channel = GetInstance("Channel") as ZGZY.IDAL.IChannel;
            return Channel;
        }
        public static ZGZY.IDAL.IFinance GetFinanceDAL()
        {
            ZGZY.IDAL.IFinance Finance = GetInstance("Finance") as ZGZY.IDAL.IFinance;
            return Finance;
        }
        public static ZGZY.IDAL.ICustomerFinance GetCustomerFinanceDAL()
        {
            ZGZY.IDAL.ICustomerFinance CustomerFinance = GetInstance("CustomerFinance") as ZGZY.IDAL.ICustomerFinance;
